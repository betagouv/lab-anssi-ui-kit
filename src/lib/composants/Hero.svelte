<svelte:options
  customElement={{
    tag: "lab-anssi-hero",
    props: {
      titre: { attribute: "titre", reflect: false, type: "String" },
      baliseTitre: { attribute: "balise-titre", reflect: false, type: "String" },
      description: { attribute: "description", reflect: false, type: "String" },
      actions: { attribute: "actions", reflect: false, type: "Object" },
      inverse: { attribute: "inverse", reflect: false, type: "Boolean" },
      urlImage: { attribute: "url-image", reflect: false, type: "String" },
      sansImage: { attribute: "sans-image", reflect: false, type: "Boolean" },
    },
  }}
/>
