...
<script lang="ts">
  ...
  interface Props {
    ...
    disabled?: boolean;
    /** Texte informatif affiché quand disabled est vrai. Utiliser le slot `text` pour du contenu riche (ex: liens). */
    text?: string;
  }
  ...
  /**
   * Indique si un type de bouton correspond à un réseau social.
   *
   * @param type Type de bouton à tester.
   *
   * @returns Vrai si le bouton est un bouton social.
   */
  ...
  /**
   * Indique si un bouton doit être désactivé lorsque le partage social est désactivé.
   *
   * @param button Bouton à tester.
   *
   * @returns Vrai si le bouton est un bouton social et que le composant est désactivé.
   */
  ...
  /**
   * Ouvre une fenêtre popup de partage pour un bouton social.
   *
   * @param event Événement de clic.
   * @param button Bouton de partage à utiliser.
   */
  ...
  /**
   * Copie l'URL courante dans le presse-papiers.
   */
