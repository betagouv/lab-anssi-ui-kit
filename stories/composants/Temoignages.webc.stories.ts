...
import TemoignagesWebComponent from "./TemoignagesWebComponent.svelte";

const meta = {
  title: "WebComponents/ANSSI/Temoignages",
  component: TemoignagesWebComponent,
  tags: ["autodocs"],
  args: {
    titre: "Titre",
    temoignages: [
...
} satisfies Meta<typeof TemoignagesWebComponent>;
