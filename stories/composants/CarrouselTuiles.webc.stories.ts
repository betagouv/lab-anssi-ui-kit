...
import CarrouselTuilesWebComponent from "./CarrouselTuilesWebComponent.svelte";

const meta = {
  title: "WebComponents/ANSSI/CarrouselTuiles",
  component: CarrouselTuilesWebComponent,
  tags: ["autodocs"],
  args: {
    tuiles: [
      {
...
} satisfies Meta<typeof CarrouselTuilesWebComponent>;
