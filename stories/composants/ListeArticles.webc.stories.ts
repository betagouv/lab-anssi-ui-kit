...
import ListeArticlesWebComponent from "./ListeArticlesWebComponent.svelte";

const meta = {
  title: "WebComponents/ANSSI/ListeArticles",
  component: ListeArticlesWebComponent,
  tags: ["autodocs"],
  args: {
    articles: [
      {
...
} satisfies Meta<typeof ListeArticlesWebComponent>;
