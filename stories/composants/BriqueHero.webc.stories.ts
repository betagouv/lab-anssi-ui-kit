...
import BriqueHeroWebComponent from "./BriqueHeroWebComponent.svelte";

const meta = {
  title: "WebComponents/ANSSI/BriqueHero",
  component: BriqueHeroWebComponent,
  tags: ["autodocs"],
  args: {
    badge: true,
...
} satisfies Meta<typeof BriqueHeroWebComponent>;
