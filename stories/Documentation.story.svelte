<script lang="ts">
  ...
  //@ts-ignore
  import stylesCSS from "../src/variables.scss?raw";
  import OutilSelecteurTheme from "./OutilSelecteurTheme.svelte";
  import IconeCopier from "./icones/IconeCopier.svelte"; // On récupère ici le contenu "raw" de notre feuille de style
