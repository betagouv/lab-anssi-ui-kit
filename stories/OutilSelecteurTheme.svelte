<script lang="ts">
  ...
  const variablesCSS = [
    ...
    "bouton-secondaire-couleur-bordure",
    "bouton-arrondi",
    ...
    "tag-couleur-fond",
    "tag-couleur-texte",
    "tag-selectionnable-couleur-texte",
    "tag-selectionnable-couleur-fond",
    "tag-selectionnable-couleur-fond-survol",
    "tag-selectionnable-couleur-fond-clique",
    "tag-selectionne-couleur-texte",
    "tag-selectionne-couleur-fond",
    "tag-selectionne-couleur-fond-survol",
    "tag-selectionne-couleur-fond-clique",
  ] as const;
