...
{#snippet template(args: Args)}
  <dsfr-quote
    text={args.text}
    size={args.size}
    has-author={args.hasAuthor ? args.hasAuthor : undefined}
    author={args.author}
    has-details={args.hasDetails ? args.hasDetails : undefined}
    sources={args.sources}
    has-image={args.hasImage ? args.hasImage : undefined}
    src={args.src}
    alt={args.alt}
    accent={args.accent}
