...
{#snippet template(args: Args)}
  <dsfr-header
    id={args.id}
    is-mourning={args.isMourning}
    menu-id={args.menuId}
    menu-modal-id={args.menuModalId}
    has-tool-links={args.hasToolLinks}
    tool-links={args.toolLinks}
    duplicate-tool-links={args.duplicateToolLinks}
    has-translate={args.hasTranslate}
    ...
    has-brand-tagline={args.hasBrandTagline}
    ...
    has-brand-operator={args.hasBrandOperator}
    ...
    has-header-tag={args.hasHeaderTag}
  >
    <!-- Tool Links -->
    <dsfr-buttons-group
      size="sm"
