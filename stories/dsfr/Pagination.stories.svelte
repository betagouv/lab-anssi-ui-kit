...
{#snippet template(args: Args)}
  <dsfr-pagination
    pages={args.pages}
    has-first-and-last={args.hasFirstAndLast}
    first={args.first}
    last={args.last}
    first-and-last-displayed-lg={args.firstAndLastDisplayedLg}
    has-prev-and-next={args.hasPrevAndNext}
    prev={args.prev}
    next={args.next}
    prev-and-next-displayed-lg={args.prevAndNextDisplayedLg}
    prev-and-next-has-lg-label={args.prevAndNextHasLgLabel}
